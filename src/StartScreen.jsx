...
function StartScreen({ onStartGame, onSelectDifficulty, selectedDifficulty }) {
  const difficulties = [
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-white mb-6">Memory Card Game</p>
        ...
        <div className="mb-6">
          <h2 className="font-medium flex items-center gap-2 mb-3 text-center text-white">
