...
const ProfilePage = ({ onBack }) => {
  ...
  const resetAllStats = () => {
    ...
    // Reset any streaks or additional stats
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 to-slate-800 py-8 px-4">
        ...
        >
          <div className="flex items-center mb-6">
            ...
            <div className="flex-grow">
              <h1 className="text-2xl font-bold text-white mr-3">{stats.playerName}</h1>
      ...
      <AnimatePresence>
        {showResetModal && (
          ...
          >
            <motion.div 
              className="bg-slate-800 rounded-2xl p-8 max-w-md shadow-2xl border border-red-500"
